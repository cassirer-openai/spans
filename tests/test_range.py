...
@pytest.mark.parametrize(
    "range_type, lower, upper, lower_inc, upper_inc, exc_type",
    [
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            floatrange(1.0, 10.0, lower_inc=False),
            floatrange(5.0, 15.0),
            floatrange(1.0, 15.0, lower_inc=False),
        ),
        (
            floatrange(1.0, 10.0),
            floatrange(5.0, 15.0, upper_inc=True),
            floatrange(1.0, 15.0, upper_inc=True),
        ),
    ...
    [
        ...
        (
            floatrange(0.0, 5.0, upper_inc=True).intersection(
                floatrange(5.0, lower_inc=False)
            ),
            True,
        ),
    ],
